...
{
    /// <inheritdoc />
    public partial class RemoveUnusedTablesAddAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dia = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Gg = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Needle = table.Column<int>(type: "integer", nullable: false),
                    Feeder = table.Column<int>(type: "integer", nullable: false),
                    Rpm = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Slit = table.Column<int>(type: "integer", nullable: false),
                    Constat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageAccessId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePageAccesses_Users_GrantedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanInviteMembers = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageAccesses_PageUrl",
                table: "PageAccesses",
                column: "PageUrl",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RolePageAccesses_GrantedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePageAccesses_RoleId",
                table: "RolePageAccesses",
                column: "RoleId");
